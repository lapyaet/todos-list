...
function generateTodoItem (item,index) {
    ...
    // secDivElement.insertAdjacentHTML("afterbegin",`<i class="fa-solid fa-pencil"></i>`)
    // secDivElement.insertAdjacentHTML("beforeend", `<i class="fa-solid fa-trash" onclick={clickDelete()}></i>`);
